...
const char * Control::getCommand() const
{
    return this->command.c_str();
}

void Control::setCommand(const char * command)
{
...
ControlDescriptor::ControlDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(Control)), "omnetpp::cMessage")
{
...
bool ControlDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Control *pp = (Control *)object; (void)pp;
    switch (field) {
        case FIELD_command: pp->setCommand((value)); return true;
