...
class Environment:
    ...
    def get_video_chunk(self, quality, print_log=False):
        ...
        while True:  # download video chunk over mahimahi
            if print_log:
                print('#'*10, 'get_video_chunk', self.trace_idx, self.mahimahi_ptr)
            ...
            if print_log:
                print('#' * 10, 'payload', packet_payload, video_chunk_size, quality)
